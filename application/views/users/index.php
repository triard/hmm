            ...
            <div class="card" style="margin-bottom: 1%;">
              <div class="card-body" style="background-color: #159d8c; border: none;">
                <div class="d-flex mb-3">
                  ...
                  <div class="p-2 ml-auto align-self-sm-center"><a href="<?= base_url('Fest/detail/') . $rows->id_ticket; ?>" class="btn btn-warning">Get ticket</a></div>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
          <a href="<?= base_url() . 'Fest'; ?>" class="btn btn-primary">SEE MORE</a>
          <br><br>
        </div>
